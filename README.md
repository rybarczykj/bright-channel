...
[uv](https://docs.astral.sh/uv/) is the project's only external dependency. Paste this command into the terminal to install 

```
curl -LsSf https://astral.sh/uv/install.sh | sh
```

4. Run the app. After `uv` is downloaded, you'll need to close and re-open the terminal to actually be able to use it. Once you've done that, this command will run the app:
